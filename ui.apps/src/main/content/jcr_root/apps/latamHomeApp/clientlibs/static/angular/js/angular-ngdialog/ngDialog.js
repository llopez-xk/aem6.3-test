            ...
            function ($document, $templateCache, $compile, $q, $http, $rootScope, $timeout, $window, $controller, $injector) {
                ...
                var privateMethods = {
                    ...
                    getActiveDialog: function () {
                        ...
                        var links =  $(".ngdialog-content").find("a");
                        if( links.length ) {
                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            if (options.showClose) {
                                template += '<button class="ngdialog-close icon-close icon-small" tabindex="0" value="Cerrar">' + '</button>';
                            }

                            template += '<div class="ngdialog-template">' + setup.template + '</div>';
